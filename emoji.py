...
emoji_dist = {0: cur_path+"/emojis/angry.png", 1: cur_path+"/emojis/disgusted.png", 2: cur_path+"/emojis/fearful.png", 3: cur_path +
              "/emojis/happy.png", 4: cur_path+"/emojis/neutral.png", 5: cur_path+"/emojis/sad.png", 6: cur_path+"/emojis/surprised.png"}
...
# cap1 = cv2.VideoCapture('C:\\Users\\sneha\\Desktop\\CDACPROJECT\\Emojify\\src\\data\\test_vid.mp4')   # specify path if not using webcam
# specify path if not using webcam
cap1 = cv2.VideoCapture(0, cv2.CAP_DSHOW)
# cap1 = cv2.VideoCapture("C:\\Users\\sneha\\Desktop\\CDACPROJECT\\Emojify\\src\\data\\test\\happy\\PrivateTest_556985.jpg")
...
def show_avatar():
    ...
    #imgtk2 = ImageTk.PhotoImage(image=frame2)
    imgtk2 = ImageTk.PhotoImage(image=Image.fromarray(RGB_img))
